...
def labelme2yolov2Seg(jsonfilePath="", resultDirPath="", classList=["empty","parked"]):
    """
...
if __name__ == "__main__":
    jsonfilePath = "E:/yema/YOLOv10/parking_data/labels_json/"  # 要转换的json文件所在目录
    resultDirPath = "E:/yema/YOLOv10/parking_data/labels/"  # 要生成的txt文件夹
    labelme2yolov2Seg(jsonfilePath=jsonfilePath, resultDirPath=resultDirPath, classList=["empty","parked"])
